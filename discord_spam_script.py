...
# Config
message_text = ":cucumber: = maxime " # Text to send.  Default: ":smiley:"
msg_time = 0.6 # Time between messages (seconds).  Default: 0.8
wait_time = 0.5 # Time to wait between each run (seconds).  Default: 5
